...
<head>
  ...
  <style>
    ...
    #notification {
        margin-bottom: 20px; /* Add margin to create space below this section */
    }
    .btnLocation-popup{
      position: absolute;
      top: 25%;
...
<body>
    ...
    <div id="notification">
        ...
        <button onclick="redirectToLocation()" class="btnLocation-popup">Edit Location</button>
      ...
      document.addEventListener('DOMContentLoaded', function() {
          ...
          fetchMatchedUserDataButton.addEventListener('click', function() {
              ...
              .then(data => {
                  let matchedData = '';
                  data.forEach(item => {
                      matchedData += `<div class="data"><p>User ID: ${item.status}<br>Username: ${item.musername}</p></div>`; 
    ...
    <form id="hero1">
        <div class="hero" id="hero">
            <div class="container">
                <div class="row">
                    <p>Get your assignment done!</p>
                    <label>
                        <input type="radio" id="checkbox1" name="option" value="1">
                        <span></span>
                    </label> 
                </div> 
                <div class="row">
                    <p>Do assignment</p>
                    <label>
                        <input type="radio" id="checkbox2" name="option" value="2">
                        <span></span>
                    </label> 
                </div> 
                <div class="conti">
