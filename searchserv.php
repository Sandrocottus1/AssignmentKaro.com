...
if ($result->num_rows > 0) {
    ...
    $updateQuery="UPDATE loc SET status = $user2Id , musername='$user2username' WHERE id IN ($user1Id)";
    $updateQuery1="UPDATE loc SET status = $user1Id , musername='$user1username' WHERE id IN ($user2Id)";
